"""
Django settings for ai_healthcare_chatbot project.
...
SECRET_KEY = 'django-insecure-_lemvk7#p_tz=3$@6_&_+29=s#4y-)nfmred9ctb64vwafrb0*'
...
TEMPLATES = [
    {
        ...
        'APP_DIRS': True,  # 🔥 THIS enables app templates
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'ai_healthcare_chatbot.wsgi.application'
